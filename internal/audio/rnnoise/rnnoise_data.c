/* rgoclient: upstream's rnnoise_data.c reduced to what
   USE_WEIGHTS_FILE compiles. The weights it would otherwise
   carry are rnnoise_data.bin. Regenerate with
   scripts/update-rnnoise.sh. */
